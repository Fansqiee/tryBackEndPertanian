...
// dbase_pertanian.query(`CREATE TABLE IF NOT EXISTS topic1 (
...
// dbase_pertanian.query(`CREATE TABLE IF NOT EXISTS topic2 (
//   timestamp TIMESTAMP NOT NULL,
//   Waterflow1 FLOAT,
//   Waterflow2 FLOAT,
//   Waterflow3 FLOAT,
...
// dbase_pertanian.query(`CREATE TABLE IF NOT EXISTS topic3 (
//   timestamp TIMESTAMP NOT NULL,
//   Suhu FLOAT,
//   Berat2 FLOAT,
//   Berat3 FLOAT,
...
//   });
  ...
  dbase_pertanian.query(`CREATE TABLE IF NOT EXISTS ics (
    timestamp TIMESTAMP NOT NULL,
    Ph FLOAT,
    TDS FLOAT,
    Suhu_Air FLOAT,
